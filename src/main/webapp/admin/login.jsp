...
<div id="main" class="panel panel-primary">
	...
	<div class="panel-body" style="background-color: #c4e3f3">
		<div style="text-align: center;">
			<span style="font-size: larger;color: #419641">天天生鲜</span>
		</div>
		<form action="${pageContext.request.contextPath}/admincontroller/login" method="post">
