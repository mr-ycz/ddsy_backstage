...
<!--导航 -->
<div style="width: 80%;margin-left: 10%;" id="adminjsp">
			...
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					...
					<ul id="sub1" class="nav collapse panel-collapse">
						<li>
							<%--<a href="${pageContext.request.contextPath}/admincontroller/userManage" id="showUser">--%>
							<a href="#" id="showUser">
				...
				<li class="panel">
					...
					<ul id="sub3" class="nav panel-collapse collapse">
						...
						<li>
							<a href="${pageContext.request.contextPath}/admincontroller/goods" id="showGoods" >
	...
	<div class="page_main">
		<script type="text/javascript">
            $("#showUser").click(function(){
                $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/userList.jsp");
            })
            $("#showGoodsType").click(function(){
                $(".dv_content").attr("src","${pageContext.request.contextPath}/admincontroller/getGoodsType");
            })
            $("#addGoodsType").click(function(){
                $(".dv_content").attr("src","${pageContext.request.contextPath}/admincontroller/readyAddGoodsType");
            })
            $("#showGoods").click(function(){
                $(".dv_content").attr("src","${pageContext.request.contextPath}/admincontroller/readyUpdateGoodsType");
            })
